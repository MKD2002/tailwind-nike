...
const Hero = () => {
  return (
    <section
      id="hero"
      className="flex flex-col justify-center w-full min-h-screen gap-10 p-2 border-2 border-red-500 xl:flex-row max-container"
    >
      ...
      <div className="relative flex items-center justify-center flex-1 bg-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-color">
        <img src={bigShoe1} alt="shoes collection" width={610} height={500} className="relative z-10 object-contain" />
      </div>
    </section>
  )
}
